# Rejigging the keyboard sensitivity to work more properly, adding a testing zone too
# 10-4-23
# Version 2
...
def menu(wn):
    buttons = [Button([sc_w / 2, 3*sc_h / 5], [sc_w/2, 80], [30, 30, 30], [60, 60, 60], "Endless", [200, 200, 200], main),
               Button([sc_w / 2, 3*sc_h / 5 + 100], [sc_w/2, 80], [30, 30, 30], [60, 60, 60], "Test Zone", [200, 200, 200], testing)]
    while True:
        wn.fill((0, 0, 0))
        clock.tick(60)
        ...
        version = font.render("Version 2", 1, (100, 100, 100))
