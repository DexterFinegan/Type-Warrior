# Adding Art Assests
# Include Word Generator Boss to Lyrics mode
# 9-5-23
# Version 4
...
# Art Assets
bg = pygame.image.load("Art_Assets/City_Skyline.png")
body = pygame.image.load("Art_Assets/boss_body.png")
...
def menu(wn):
    ...
    while True:
        ...
        version = font.render("Version 4", 1, (100, 100, 100))
...
def lyrics_race(wn, file, mode):
    ...
    while True:
        ...
        pygame.draw.line(wn, (255, 0, 0), (0, sc_h - 30), (sc_w, sc_h - 30), 1)         # For Testing Purposes

        # Test Square
        wn.blit(body, (sc_w/2 - 50, 100))
